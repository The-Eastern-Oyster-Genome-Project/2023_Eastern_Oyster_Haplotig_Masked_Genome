...
png(filename="./Output/Figures/Figure1.CoverageComparison.png", type="cairo",units="px", width=5600, height=3000, res=300, bg="transparent")
...
![Figure 1- Coverage Comparison](./Output/Figures/Figure1.CoverageComparison.png)
...
![Figure S1- Coverage by Chromsome](./Output/Figures/Supplemental/FigureS1.CoverageChromosome2.png)
...
md4 <- ggplot(dfm, aes(x= index, y=marker, colour = as.factor(chrom_alt),size=(0.1+ abs(marker))^2))+
  ...
  labs(y=paste("Difference in ", expression(pi))) +
