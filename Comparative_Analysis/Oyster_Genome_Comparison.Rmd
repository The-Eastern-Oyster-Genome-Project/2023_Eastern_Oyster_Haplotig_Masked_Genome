...
null <- dev.off()
```
![Figure 5- Estimates of FST across genomeversions](./Output/Figures/Figure5.FST.man.png)
...
![Figure S6- FST extimates in the LSS across new diplotigs](./Output/Figures/Supplemental/LSS.FST.diplotigs.png)
