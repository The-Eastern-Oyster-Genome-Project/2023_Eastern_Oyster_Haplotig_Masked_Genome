...
![Figure S2-BUSCO Results](./Output/BUSCO/Summaries/busco_figure.png)
```{bash eval=FALSE}
source activate busco
cd Output/BUSCO
...
```
Output figure from `BUSCO`
![Figure S2-BUSCO Results](./Output/BUSCO/Gigas_Comparison/busco_figure.png)
...
Run modified dDocent pipeline **but make sure to change number of processors to match your machine and your email address**
```{bash eval = FALSE}
...
```{r, message=FALSE, warning=FALSE, out.width = "400px", echo=FALSE}
cbPalette1 <- c("#D55E00","#999999","#E69F00","#CC79A7","#009E73","#7d5577")
graph.breaks <- c("Masked","Original")
graph.labels <- c("Haplotig Masked", "Original")

dataframe1<- read.table("dataframehm.bed", sep="\t", header=T)
png(filename="./Output/Figures/Figure.1.CoverageComparison.png", type="cairo",units="px", width=5600, height=3000, res=300, bg="transparent")
...
![Figure 1- Coverage Comparison](./Output/Figures/Figure.1.CoverageComparison.png)
...
![Figure S1- Coverage by Chromsome](./Output/Figures/Supplemental/Figure.S1.CoverageChromosome2.png)
...
For consistency with the manuscript, Figure 2 is printed here.  Code is below, as more parameter calculations are needed to create it.

![Figure 2 Paramters across Chromosome 2](./Output/Figures/Figure.2.PopGenParametersChrom2.png)
...
null <- dev.off()
```
![Figure 3 Nucleotide Diversity Comparison](Output/Figures/Figure.3.nucleotide.diversity.png)
...
![Figure 4 Nucleotide Diversity in new Diplotigs](./Output/Figures/Figure.4.Nucleotide.Diversity.Diplotigs.png)
...
```
![Supplemental Figure 3- Haplotig effects on heterozygosity](./Output/Figures/Supplemental/Figure.S4.Heterozygosity.man.png)
...
![Supplemental Figure S4- Heterzygosity in new diplotigs](./Output/Figures/Supplemental/Figure.S5.HeterozygosityDiplotigs.png)
...
null <- dev.off()
```
![Figure 5- Estimates of FST across genomeversions](./Output/Figures/Figure.5.FST.man.png)
...
![Figure 6- Estimates of FST across genome versions](Output/Figures/Figure.6.MvO.LSS.FST.man.png)
...
![Figures S5-FST estimates across new diplotigs](./Output/Figures/Supplemental/Figure.S6.Full.FST.diplo.png)
...
![Figure S6- FST extimates in the LSS across new diplotigs](./Output/Figures/Supplemental/Figure.S7.LSS.FST.diplotigs.png)
...
![Figure S7- VST across the genome versions](./Output/Figures/Supplemental/Figure.S8.all.VSTs.man.png)
...
![Figure S8-VST estimates in the LSS](./Output/Figures/Supplemental/Figure.S9.VST.LSS.png)