...
cp ./Gigas_Comparison/busco_figure.png ../Figures/Supplemental/Figure.SX.Gigas_BUSCO.png
```
Output figure from `BUSCO`
...
```
![Supplemental Figure 3- Haplotig effects on heterozygosity](./Output/Figures/Supplemental/Figure.S3.Heterozygosity.man.png)
...
![Supplemental Figure S4- Heterzygosity in new diplotigs](./Output/Figures/Supplemental/Figure.S4.HeterozygosityDiplotigs.png)
...
![Figures S5-FST estimates across new diplotigs](./Output/Figures/Supplemental/Figure.S5.Full.FST.diplo.png)
...
![Figure S6- FST extimates in the LSS across new diplotigs](./Output/Figures/Supplemental/Figure.S6.LSS.FST.diplotigs.png)
...
![Figure S7- VST across the genome versions](./Output/Figures/Supplemental/Figure.S7.all.VSTs.man.png)
...
![Figure S8-VST estimates in the LSS](./Output/Figures/Supplemental/Figure.S8.VST.LSS.png)