...
```{bash eval = FALSE, include=FALSE}
wget https://github.com/The-Eastern-Oyster-Genome-Project/2021_Genome_Submissions/raw/main/Haplotig_Masking/Output/Masked_Genome/reference.masked.fasta
mv reference.masked.fasta reference.fasta
```
